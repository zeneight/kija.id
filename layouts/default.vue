    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:thezeneight@gmail.com" class="text-white hover:text-gray-400">
          ...
          <!-- <li>
            <a href="https://www.youtube.com/c/AgungPriambada" target="_blank" class="text-white hover:text-gray-400">
          ...
          <!-- <li>
            <a href="https://github.com/zeneight" target="_blank" class="text-white hover:text-gray-400">
          ...
          <!-- <li>
            <a href="https://twitter.com/zeneight" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/kija.id" target="_blank" class="text-white hover:text-gray-400">
